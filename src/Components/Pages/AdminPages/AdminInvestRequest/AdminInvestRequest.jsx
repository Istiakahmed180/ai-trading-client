  ...
  const handleApprovedData = async (id) => {
    try {
      const fetchApprovedData = await axios.put(
        `https://usa-ai-trading-server.vercel.app/invest/admin/approve/${id}`
      );
  ...
  const handleInvestRequestDelete = async (id) => {
    try {
      const fetchDeletetingData = await axios.delete(
        `https://usa-ai-trading-server.vercel.app/invest/admin/invest-request-delete/${id}`
      );
    ...
    const fetchPendingData = async () => {
      try {
        ...
        const response = await axios.get(
          "https://usa-ai-trading-server.vercel.app/invest/admin/invest-request"
        );
